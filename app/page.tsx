...
import { loadState, saveState, createTopic, createNotification } from "@/lib/store"
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      ...
      <SlidingSidebar side="left" icon={<List className="w-5 h-5" />}>
        <TopicsSidebar topics={topics} onTopicClick={handleTopicClick} selectedTopicId={selectedTopic?.id} />
      </SlidingSidebar>
